...
class AdminRoleController extends Controller
{
    ...
    public function view(){
        ...
        $roles = [
            ...
            'Village' => ['all', 'view', 'status', 'add', 'edit', 'delete'],
            ...
            'Village Profile' => ['all', 'edit', 'delete'],
            ...
            'Provider' => ['all', 'view', 'status', 'add', 'edit', 'delete'],
            ...
            'Provider Cover' => ['all', 'view', 'status', 'add', 'delete'],
            ...
            'Provider Maintenance' => ['all', 'view', 'status', 'add', 'edit', 'delete'],
            ...
            'Provider Maintenance Profile' => ['all', 'edit', 'delete'],
