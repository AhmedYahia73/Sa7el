...
namespace App\Http\Controllers\api\MaintenanceProvider\Offer;
...
use App\Models\MProviderOffer;

class OfferController extends Controller
{
    public function __construct(private MProviderOffer $provider_offer){}
    use TraitImage;
